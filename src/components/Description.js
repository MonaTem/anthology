  ...
  <div className="media-body">
    <div className="row">
      <div className="col-12 offset-5 text-left description">
        ...
        The real game-changer, though, was and is technology. In this regard has storytelling seen many "new ages" since the dawn of humanity. From people sitting at the fire, listening together to stories, to the internet which enables global audiences, and new technologies like AR/VR which create new user experiences happened many remarkable steps. While everyone today seems to be excited of storytelling, everyone uses the expression in a different context with different meanings. This is a new Babylon in which we live day by day. Twenty-three authors contribute to this reflection of storytelling with their angle, their insights, as storytellers, scientists, technologists, economists, psychologists, marketers.
